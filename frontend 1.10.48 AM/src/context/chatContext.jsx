...
const ChatContextProvider = (props) => {
  const { messages, addMessage,   deleteMessage, clearChat, sliceMessages } = useMessageCollection();

  return (
    <ChatContext.Provider value={[messages, addMessage, clearChat,deleteMessage,sliceMessages]}>
      {props.children}
